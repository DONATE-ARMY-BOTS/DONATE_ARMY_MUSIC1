...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002135034807"))


# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6663210749").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/DONATE-ARMY-BOTS/DONATE_ARMY_MUSIC",
)
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/DONATE_ARMY_BOTS_CHAT_GROUP"
)  # Example:- https://t.me/DONATE_ARMY_BOTS_CHAT_GROUP
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/DONATE-ARMY-BOTS/DONATE_ARMY_MUSIC")
...
YTDOWNLOADER = 1
LOG = 2
LOG_FILE_NAME = "DONATE_ARMY_BOTS_LOGS.txt"
